...
public:
	...
	void action_Highlight_Syntax(DocumentWidget *document);
	void action_Apply_Backlighting(DocumentWidget *document);
	void action_Make_Backup_Copy(DocumentWidget *document);
	...
	void action_Default_Search_Verbose(DocumentWidget *document);
	void action_Default_Search_Wrap_Around(DocumentWidget *document);
	void action_Default_Search_Beep_On_Search_Wrap(DocumentWidget *document);
	void action_Default_Search_Keep_Dialogs_Up(DocumentWidget *document);
	void action_Default_Apply_Backlighting(DocumentWidget *document);
	void action_Default_Tab_Open_File_In_New_Tab(DocumentWidget *document);
	void action_Default_Tab_Show_Tab_Bar(DocumentWidget *document);
	void action_Default_Tab_Hide_Tab_Bar_When_Only_One_Document_is_Open(DocumentWidget *document);
	void action_Default_Tab_Next_Prev_Tabs_Across_Windows(DocumentWidget *document);
	void action_Default_Tab_Sort_Tabs_Alphabetically(DocumentWidget *document);
	void action_Default_Show_Tooltips(DocumentWidget *document);
	void action_Default_Statistics_Line(DocumentWidget *document);
	void action_Default_Incremental_Search_Line(DocumentWidget *document);
	void action_Default_Show_Line_Numbers(DocumentWidget *document);
	void action_Default_Make_Backup_Copy(DocumentWidget *document);
	void action_Default_Incremental_Backup(DocumentWidget *document);
	void action_Default_Matching_Syntax_Based(DocumentWidget *document);
	void action_Default_Terminate_with_Line_Break_on_Save(DocumentWidget *document);
	void action_Default_Popups_Under_Pointer(DocumentWidget *document);
	void action_Default_Auto_Scroll_Near_Window_Top_Bottom(DocumentWidget *document);
	void action_Default_Warnings_Files_Modified_Externally(DocumentWidget *document);
	void action_Default_Warnings_Check_Modified_File_Contents(DocumentWidget *document);
	void action_Default_Warnings_On_Exit(DocumentWidget *document);
