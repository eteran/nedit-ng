...
#define BTN_TEXT_OFFSET 3
	...
	primaryFrame = XtVaCreateManagedWidget("primaryFrame", xmFrameWidgetClass, form, XmNmarginHeight, 3, XmNtopAttachment, XmATTACH_POSITION, XmNtopPosition, 2, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 1, XmNrightAttachment,
	                                       XmATTACH_POSITION, XmNrightPosition, 99, nullptr);
	primaryForm = XtVaCreateManagedWidget("primaryForm", xmFormWidgetClass, primaryFrame, nullptr);
	primaryLbl = XtVaCreateManagedWidget("primaryFont", xmLabelGadgetClass, primaryFrame, XmNlabelString, s1 = XmStringCreateSimpleEx("Primary Font"), XmNmnemonic, 'P', XmNchildType, XmFRAME_TITLE_CHILD, XmNchildHorizontalAlignment,
	...
	italicBtn = XtVaCreateManagedWidget("italicBtn", xmPushButtonWidgetClass, highlightForm, XmNlabelString, s1 = XmStringCreateSimpleEx("Browse..."), XmNmnemonic, 'o', XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, italicLbl,
	                                    XmNtopOffset, BTN_TEXT_OFFSET, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 1, nullptr);
	XmStringFree(s1);
	...
	boldLbl = XtVaCreateManagedWidget("boldLbl", xmLabelGadgetClass, highlightForm, XmNlabelString, s1 = XmStringCreateSimpleEx("Bold Font"), XmNmnemonic, 'B', XmNalignment, XmALIGNMENT_BEGINNING, XmNtopAttachment, XmATTACH_WIDGET,
	                                  XmNtopWidget, italicBtn, XmNtopOffset, MARGIN_SPACING, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 1, nullptr);
	XmStringFree(s1);

	fd->boldErrW = XtVaCreateManagedWidget("boldErrLbl", xmLabelGadgetClass, highlightForm, XmNlabelString, s1 = XmStringCreateSimpleEx(""), XmNalignment, XmALIGNMENT_END, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, italicBtn,
	                                       XmNtopOffset, MARGIN_SPACING, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, boldLbl, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 99, nullptr);
	XmStringFree(s1);

	boldBtn = XtVaCreateManagedWidget("boldBtn", xmPushButtonWidgetClass, highlightForm, XmNlabelString, s1 = XmStringCreateSimpleEx("Browse..."), XmNmnemonic, 'w', XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, boldLbl, XmNtopOffset,
	                                  BTN_TEXT_OFFSET, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 1, nullptr);
	XmStringFree(s1);
	XtAddCallback(boldBtn, XmNactivateCallback, boldBrowseCB, fd);

	fd->boldW = XtVaCreateManagedWidget("bold", xmTextWidgetClass, highlightForm, XmNmaxLength, MAX_FONT_LEN, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, boldBtn, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, boldLbl,
	                                    XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 99, nullptr);
	RemapDeleteKey(fd->boldW);
	XtAddCallback(fd->boldW, XmNvalueChangedCallback, boldModifiedCB, fd);
	XtVaSetValues(boldLbl, XmNuserData, fd->boldW, nullptr);

	boldItalicLbl = XtVaCreateManagedWidget("boldItalicLbl", xmLabelGadgetClass, highlightForm, XmNlabelString, s1 = XmStringCreateSimpleEx("Bold Italic Font"), XmNmnemonic, 'l', XmNalignment, XmALIGNMENT_BEGINNING, XmNtopAttachment,
	                                        XmATTACH_WIDGET, XmNtopWidget, boldBtn, XmNtopOffset, MARGIN_SPACING, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 1, nullptr);
	XmStringFree(s1);

	fd->boldItalicErrW = XtVaCreateManagedWidget("boldItalicErrLbl", xmLabelGadgetClass, highlightForm, XmNlabelString, s1 = XmStringCreateSimpleEx(""), XmNalignment, XmALIGNMENT_END, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
	                                             boldBtn, XmNtopOffset, MARGIN_SPACING, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, boldItalicLbl, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 99, nullptr);
	XmStringFree(s1);

	boldItalicBtn = XtVaCreateManagedWidget("boldItalicBtn", xmPushButtonWidgetClass, highlightForm, XmNlabelString, s1 = XmStringCreateSimpleEx("Browse..."), XmNmnemonic, 's', XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, boldItalicLbl,
	                                        XmNtopOffset, BTN_TEXT_OFFSET, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 1, nullptr);
	XmStringFree(s1);
	XtAddCallback(boldItalicBtn, XmNactivateCallback, boldItalicBrowseCB, fd);

	fd->boldItalicW = XtVaCreateManagedWidget("boldItalic", xmTextWidgetClass, highlightForm, XmNmaxLength, MAX_FONT_LEN, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, boldItalicBtn, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
	                                          boldItalicLbl, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 99, nullptr);
	...
	okBtn = XtVaCreateManagedWidget("ok", xmPushButtonWidgetClass, form, XmNlabelString, s1 = XmStringCreateSimpleEx("OK"), XmNmarginWidth, BUTTON_WIDTH_MARGIN, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, highlightFrame, XmNtopOffset,
	                                MARGIN_SPACING, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, forWindow ? 13 : 26, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, forWindow ? 27 : 40, nullptr);
	XtAddCallback(okBtn, XmNactivateCallback, fontOkCB, fd);
	XmStringFree(s1);

	if (forWindow) {
		applyBtn = XtVaCreateManagedWidget("apply", xmPushButtonWidgetClass, form, XmNlabelString, s1 = XmStringCreateSimpleEx("Apply"), XmNmnemonic, 'A', XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, highlightFrame, XmNtopOffset,
		                                   MARGIN_SPACING, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 43, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 57, nullptr);
		XtAddCallback(applyBtn, XmNactivateCallback, fontApplyCB, fd);
		XmStringFree(s1);
	}

	cancelBtn = XtVaCreateManagedWidget("cancel", xmPushButtonWidgetClass, form, XmNlabelString, s1 = XmStringCreateSimpleEx(forWindow ? (char *)"Close" : (char *)"Cancel"), XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, highlightFrame,
	                                    XmNtopOffset, MARGIN_SPACING, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, forWindow ? 73 : 59, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, forWindow ? 87 : 73, nullptr);
...
static int showFontStatus(fontDialog *fd, Widget fontTextFieldW, Widget errorLabelW) {
	...
	XtVaSetValues(errorLabelW, XmNlabelString, s = XmStringCreateSimpleEx(msg), nullptr);
	XmStringFree(s);
	return status;
}
...
static int verifyAllColors(colorDialog *cd) {
	...
	return (checkColorStatus(cd, cd->textFgW) && checkColorStatus(cd, cd->textBgW) && checkColorStatus(cd, cd->selectFgW) && checkColorStatus(cd, cd->selectBgW) && checkColorStatus(cd, cd->hiliteFgW) &&
	        checkColorStatus(cd, cd->hiliteBgW) && checkColorStatus(cd, cd->lineNoFgW) && checkColorStatus(cd, cd->cursorFgW));
}
...
static Boolean checkColorStatus(colorDialog *cd, Widget colorFieldW) {
	...
	XtVaGetValues(cd->shell, XtNcolormap, &cMap, nullptr);
...
/* Add a label, error label, and text entry label with a validation
    callback */
static Widget addColorGroup(Widget parent, const char *name, char mnemonic, const char *label, Widget *fieldW, Widget *errW, Widget topWidget, int leftPos, int rightPos, XtCallbackProc modCallback, colorDialog *cd) {
	Widget lblW;
	char *longerName;
	XmString s1;
	...
	lblW = XtVaCreateManagedWidget(longerName, xmLabelGadgetClass, parent, XmNlabelString, s1 = XmStringCreateSimpleEx(label), XmNmnemonic, mnemonic, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, topWidget, XmNtopOffset, MARGIN_SPACING,
	                               XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, leftPos, nullptr);
	XmStringFree(s1);

	/* The error label widget */
	strcpy(&(longerName[nameLen]), "ErrLbl");
	*errW = XtVaCreateManagedWidget(longerName, xmLabelWidgetClass, parent, XmNlabelString, s1 = XmStringCreateSimpleEx("(Invalid!)"), XmNalignment, XmALIGNMENT_END, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, topWidget, XmNtopOffset,
	                                MARGIN_SPACING, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, lblW, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, rightPos, nullptr);
	XmStringFree(s1);

	/* The text field entry widget */
	*fieldW = XtVaCreateManagedWidget(name, xmTextWidgetClass, parent, XmNcolumns, MAX_COLOR_LEN - 1, XmNmaxLength, MAX_COLOR_LEN - 1, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, leftPos, XmNrightAttachment, XmATTACH_POSITION,
	                                  XmNrightPosition, rightPos, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, lblW, nullptr);
	RemapDeleteKey(*fieldW);
	XtAddCallback(*fieldW, XmNvalueChangedCallback, modCallback, cd);
	XtVaSetValues(lblW, XmNuserData, *fieldW, nullptr);
...
void ChooseColors(WindowInfo *window) {
	...
	cd->window = window;
	XtVaSetValues(cd->shell, XmNtitle, "Colors", nullptr);
	...
	tmpW = XtVaCreateManagedWidget("sep", xmSeparatorGadgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, tmpW, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM, nullptr);

	/* The OK, Apply, and Cancel buttons */
	okBtn = XtVaCreateManagedWidget("ok", xmPushButtonWidgetClass, form, XmNlabelString, s1 = XmStringCreateSimpleEx("OK"), XmNmarginWidth, BUTTON_WIDTH_MARGIN, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, tmpW, XmNtopOffset,
	                                MARGIN_SPACING, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 10, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 30, nullptr);
	XtAddCallback(okBtn, XmNactivateCallback, colorOkCB, cd);
	XmStringFree(s1);

	applyBtn = XtVaCreateManagedWidget("apply", xmPushButtonWidgetClass, form, XmNlabelString, s1 = XmStringCreateSimpleEx("Apply"), XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, tmpW, XmNtopOffset, MARGIN_SPACING, XmNmnemonic, 'A',
	                                   XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 40, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 60, nullptr);
	XtAddCallback(applyBtn, XmNactivateCallback, colorApplyCB, cd);
	XmStringFree(s1);

	closeBtn = XtVaCreateManagedWidget("close", xmPushButtonWidgetClass, form, XmNlabelString, s1 = XmStringCreateSimpleEx("Close"), XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, tmpW, XmNtopOffset, MARGIN_SPACING, XmNleftAttachment,
	                                   XmATTACH_POSITION, XmNleftPosition, 70, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 90, nullptr);
