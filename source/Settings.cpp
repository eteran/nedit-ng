...
void Settings::loadPreferences() {
    ...
    shellCommands = settings.value(tr("nedit.shellCommands"), QLatin1String("spell:Alt+B:s:EX:\n    cat>spellTmp; xterm -e ispell -x spellTmp; cat spellTmp; rm spellTmp\n    wc::w:ED:\nwc | awk '{print $1 \" lines, \" $2 \" words, \" $3 \" characters\"}'\n    sort::o:EX:\nsort\nnumber lines::n:AW:\nnl -ba\nmake:Alt+Z:m:W:\nmake\n    expand::p:EX:\nexpand\nunexpand::u:EX:\nunexpand\n")).toString();
#elif defined(Q_OS_FREEBSD)
    shellCommands = settings.value(tr("nedit.shellCommands"), QLatin1String("spell:Alt+B:s:EX:\n    cat>spellTmp; xterm -e ispell -x spellTmp; cat spellTmp; rm spellTmp\n    wc::w:ED:\nwc | awk '{print $2 \" lines, \" $1 \" words, \" $3 \" characters\"}'\n    sort::o:EX:\nsort\nnumber lines::n:AW:\npr -tn\nmake:Alt+Z:m:W:\nmake\n    expand::p:EX:\nexpand\nunexpand::u:EX:\nunexpand\n")).toString();
#else
    shellCommands = settings.value(tr("nedit.shellCommands"), QLatin1String("spell:Alt+B:s:ED:\n    (cat;echo \"\") | spell\nwc::w:ED:\nwc | awk '{print $1 \" lines, \" $2 \" words, \" $3 \" characters\"}'\n    \nsort::o:EX:\nsort\nnumber lines::n:AW:\nnl -ba\nmake:Alt+Z:m:W:\nmake\n    expand::p:EX:\nexpand\nunexpand::u:EX:\nunexpand\n")).toString();
#endif
