...
static const char *DefaultPatternSets[] = {"Ada:1:0{\n\
	Comments:\"--\":\"$\"::Comment::\n\
	String Literals:\"\"\"\":\"\"\"\":\"\\n\":String::\n\
	...
	braces:\"[{}]\":::Keyword::D\n\
	markers:\"(?<!\\Y)(%\\{|%\\}|%%)(?!\\Y)\":::Flag::D}",         "Makefile:8:0{\n\
	Comment:\"#\":\"$\"::Comment::\n\
	...
	define Ends:\"^( *| [ \\t]*)<endef>\":::Keyword::D}",  "Matlab:1:0{\n\
	Comment:\"%\":\"$\"::Comment::\n\
	...
	Operators:\"\\+|-|\\*|\\*\\*|/|//|%|\\<\\<|\\>\\>|\\&|\\||\\^|~|\\<|\\>|\\<=|\\>=|==|!=\":::Keyword::\n\
	Delimiter:\"\\(|\\)|\\[|\\]|\\{|\\}|,|:|\\.|;|=|\\+=|-=|\\*=|/=|//=|%=|\\&=|\\|=|\\^=|\\>\\>=|\\<\\<=|\\*\\*=\":::Keyword::\n\
	Invalid:\"\\$|\\?|<(?:0[bB]\\w+|0[xX]\\w+|(?:0|[1-9]\\d*)\\w+)>\":::Flag::}",     "Regex:1:0{\n\
	...
	info:\"(?# version 0.1; author/maintainer: Joor Loohuis, joor@loohuis-consulting.nl)\":::Comment::D}",        "X Resources:2:0{\n\
...
#define LIST_RIGHT 41
	...
	HighlightDialog.langModeName = XtNewString(LanguageModeName(window->languageMode == PLAIN_LANGUAGE_MODE ? 0 : window->languageMode));
