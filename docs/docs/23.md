...
file (see "[Preferences](29)"), and from the command line. Macro menu
...
menus can be found in the section [Preferences](29).
...
Subroutines](24)", and "[Action Routines](27)").
...
"[Metacharacters](17)", except that an octal escape sequence can start
...
functions in the section titled "[Macro Subroutines](24)".
...
files, such as the autoload macro file (see "[Preferences](29)"). Macro
...
section called "[Macro Subroutines](24)".
