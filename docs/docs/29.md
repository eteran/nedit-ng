...
## Preferences Menu
  ...
  - Language Mode  
    ...
    NEdit-ng](10) for more information
  ...
  - Auto Indent  
    ...
    details at [Auto/Smart Indent](12)
  ...
  - Highlight Syntax  
    ...
    enhance viewing of the file. (See [Syntax Highlighting](13) for
    more information.)
  ...
  - Incremental Backup  
    ...
    name `~filename` (see [Crash Recovery](36))
...
menu are:
  ...
  - Tag Collisions  
    ...
    in the section: [Finding Declarations (ctags)](14). In Show All
  ...
  - Colors...  
    ...
    patterns use see [Syntax Highlighting](13).)
  ...
  - Syntax Highlighting  
    ...
    languages. (See [Syntax Highlighting](13).)
  ...
  - Show Tooltips  
    ...
    over a tab. (See [Tabbed Editing](08).)
